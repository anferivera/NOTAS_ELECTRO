...
\begin{figure}
\begin{center}
\includegraphics[scale=0.4]{ley1}[h]
\end{center}
\label{ley1}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.4]{ley2}
\end{center}
\caption{Segunda ley de Kepler}
\label{ley2}
\end{figure}

Kepler obtuvo dicha ley estudiando detenidamente los datos obtenido en las observaciones astronómicas de Tycho. En la Fig.~\ref{ley2} podemos ver que el área barrida en un tiempo $t$ fijo, siempre es $A$. 
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.8]{perihelio}
\end{center}
\label{elipse}
...
De acuerdo a la Fig.~\ref{elipse}:
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.9]{fuerzagravitacional}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.6]{sistema-binario-Mm}\hspace{1.0 cm}
\includegraphics[scale=0.6]{sistema-binario-mm}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.8]{cambio-de-orbita}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.8]{campo}
\label{campo}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.9]{figcampogcontinuo}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.9]{energiapotencial}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.9]{tresmasas}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.8]{superficie}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.7]{camposuperposicion}
\end{center}
...
Consideremos el movimiento de un cuerpo de masa $m$ alrededor de un cuerpo de masa $M>m$ tal como se muestra en la Fig.~\ref{fig:}.
%
...
\end{align}
Por otro lado, usando la definición de momento angular, tenemos:
\begin{align}
\label{eq:L}
\vec{L}=m\,\vec{r}\times\vec{v}=m\,\vec{r}\times(\vec{v_r}+\vec{v_\theta})= m\,\vec{r}\times\vec{v_\theta} \to L = m\,r \left(r\dfrac{d\theta}{dt}\right)\,.
\end{align}
Reemplazando la ec.~\eqref{eq:L} en la ec.~\eqref{eq:E-mecanica}:
\begin{align}
\label{eq:drdthetat}
...
\end{equation}
donde $\epsilon$ es la excentricidad de la cónica, $d$ es la distancia a la directriz y $r,\theta$ son la coordenadas polares.
Usando la anterior ecuación se tiene que:
\begin{equation}
\label{eq:conica-drdtheta}
\left(\dfrac{dr}{d\theta}\right)^2=\dfrac{r^4\sin\theta^2}{d^2}\,.
\end{equation}
Comparando las ecs.~\eqref{eq:drdthetat} y~\eqref{eq:conica-drdtheta} tenemos que:
\begin{align}
...
Interpretación de las anteriores ecuaciones:
\begin{table}[h]
\begin{center}
...
\hline
&&&\\
Elipse & $\epsilon<1$ & $E=-\dfrac{GMm}{2a} < 0$& $L^2=Gm^2Ma(1-\epsilon^2)$\\
&&&\\
\hline
&&&\\ 
...
Note que el tamaño de la elipse está determinado por la energía, es decir $E\approx -1 /a$, sin embargo, la forma de la elipse está determinado por el momento angular (pudene tenerse muchas órbitas con la misma energía, pero con distinto momento angular). Por ejemplo como se muestra en la Fig.~\ref{fig:}.
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.8]{barra1}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.9]{barra2}
\end{center}
\caption{Campo en el eje de una barra de longitud $l$.}
\label{figbarra2}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=1.0]{barra3}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.7]{anillo}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.6]{arandela}
\end{center}
\caption{Arandela}
\label{arandela}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.7]{esfera1}
\end{center}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.7]{esfera2}
\end{center}
