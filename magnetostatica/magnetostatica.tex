...
Una partícula de carga $q$, con velocidad $\vec{v}$ que entra a una región del espación deonde existe un campo magnético $\vec{B}$, siente una fuerza magnética:
...
Note que si el alambre es infinito basta con tomar el límite cuando $x_1$ y $x_2$ tienden a infinito ó $\theta_1 =0°$ y $\theta_2=\pi/2$. 
